...
export interface HospitalServiceDetail {
  price: number;
  available: boolean;
  nextSlot: string;
  slots: string[];
  machineType?: string;
  reportTurnaround: string; // e.g. "12 Hours", "24 Hours"
}
...
export interface Hospital {
  ...
  amenities: string[];
  services: { [key: string]: HospitalServiceDetail };
  reviews: Review[];
}
...
export const ADMIN_ANALYTICS = {
  monthlyRevenue: [
    { month: "Jan", revenue: 145000, bookings: 32 },
    { month: "Feb", revenue: 168000, bookings: 38 },
    { month: "Mar", revenue: 195000, bookings: 45 },
    { month: "Apr", revenue: 180000, bookings: 40 },
    { month: "May", revenue: 210000, bookings: 49 },
    { month: "Jun", revenue: 254000, bookings: 58 }
  ],
  popularServices: [
    { name: "MRI Scan", value: 35, color: "#2563EB" },
    { name: "Blood Test", value: 25, color: "#10B981" },
    { name: "CT Scan", value: 18, color: "#F59E0B" },
    { name: "Ultrasound", value: 12, color: "#EC4899" },
    { name: "X-Ray", value: 10, color: "#8B5CF6" }
  ],
  appointmentStats: {
    total: 262,
    upcoming: 14,
